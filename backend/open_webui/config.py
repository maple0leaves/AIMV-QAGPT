...
# /home/te/TE/open-webui-main/open-webui-main/backend/open_webui/static
STATIC_DIR = Path(os.getenv("STATIC_DIR", OPEN_WEBUI_DIR / "static")).resolve()
print("STATIC_DIR:"+STATIC_DIR.__str__())
...
# /home/te/TE/open-webui-main/open-webui-main/build/static/splash.png
frontend_splash = FRONTEND_BUILD_DIR / "static" / "splash.png"
print("frontend_splash:"+frontend_splash.__str__())
